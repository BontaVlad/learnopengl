...
/* Command for C compiler:
   gcc -c  -w  -I/home/vlad/Nim/lib -o /home/vlad/Sandbox/learnopengl/getting_started/nimcache/stdlib_dynlib.o /home/vlad/Sandbox/learnopengl/getting_started/nimcache/stdlib_dynlib.c */
...
N_NIMCALL(void*, loadLibPattern_WEB1hEy1GGlzZ6WVcUBFGA)(NimStringDesc* pattern, NIM_BOOL global_symbols) {
	...
	libCandidates_z61W6kN39aBKDgNtbcWn9cSg(pattern, (&candidates));
	{
		...
		NI T2_;
		c = (NimStringDesc*)0;
		nimln_(3654, "system.nim");
		i = ((NI) 0);
		nimln_(3655, "system.nim");
		T2_ = (candidates ? candidates->Sup.len : 0);
		L = T2_;
		{
			nimln_(3656, "system.nim");
			while (1) {
